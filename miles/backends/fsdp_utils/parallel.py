...
def build_fsdp_meshes(
    ...
    # Same ranks with a degree-1 shard axis: params stay replicated (no all-gather) and grads
    # all-reduce, for the small modules the precision spec pins (see precision.WrapUnit.shard).

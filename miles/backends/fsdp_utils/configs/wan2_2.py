...
class Wan2_2TrainPipelineConfig(TrainPipelineConfig):
    ...
    # Wan DiT expects raw scheduler timesteps (0..num_train_timesteps), no /1000 scaling: it
    # inherits the identity process_timestep_as_input and the scaling process_sigma_as_input.
